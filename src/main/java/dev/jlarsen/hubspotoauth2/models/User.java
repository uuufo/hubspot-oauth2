...
public class User {
    ...
    public LocalDateTime getAuthStart() {
        return authStart;
    }

    public void setAuthStart(LocalDateTime authStart) {
        this.authStart = authStart;
    }

    public HubspotApp getApp() {
        return app;
    }

    public void setApp(HubspotApp app) {
        this.app = app;
    }
